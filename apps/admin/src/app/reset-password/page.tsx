...
function ResetPasswordForm() {
  ...
  const onSubmit = async (data: FormValues) => {
    ...
    try { await authApi.resetPassword(token, data.newPassword); setDone(true); }
    catch (err: any) { setServerError(err?.response?.data?.message ?? 'This reset link is invalid or has expired.'); }
            ...
            <form onSubmit={handleSubmit(onSubmit)} style={{ display:'flex', flexDirection:'column', gap:'16px' }}>
              <div>
                ...
                <PasswordInput
                  ...
                  className="fi" placeholder="Minimum 8 characters"
              ...
              <div>
                ...
                <PasswordInput
                  ...
                  className="fi" placeholder="Re-enter new password"
