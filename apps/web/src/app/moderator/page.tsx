...
export default function ModeratorPage() {
  ...
  return (
    <div className="mod-layout" style={{ minHeight:'calc(100vh - 68px)' }}>
      {/* Sidebar */}
      <div className="mod-sidebar" style={{ background:'linear-gradient(180deg,rgba(6,13,42,0.99),rgba(3,9,26,1))', borderRight:'1px solid var(--border)', padding:'20px 0' }}>
        <div className="mod-sidebar-title" style={{ fontFamily:'Cinzel,serif', fontSize:'11px', fontWeight:700, color:'#fff', padding:'0 20px 14px', marginBottom:'10px', borderBottom:'1px solid var(--bf)', letterSpacing:'1px' }}>🛡️ Moderator Panel</div>
        {TABS.map(t=>(
          <div key={t.key} onClick={()=>setTab(t.key)} className="mod-sidebar-item" style={{
      ...
      {/* Main */}
      <div className="mod-main" style={{ flex:1, overflowY:'auto', padding:'28px' }}>
        {/* Stats row */}
