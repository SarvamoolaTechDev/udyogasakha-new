...
export default function ForgotPasswordPage() {
  ...
  const onSubmit = async (data: FormValues) => {
    ...
    try {
      ...
      // Intentionally ignore errors here too — always show the same
      // generic confirmation regardless of outcome, to avoid leaking
    ...
    <div style={{ minHeight:'100vh', display:'flex', alignItems:'center', justifyContent:'center', padding:'40px 16px', background:'var(--deep)' }}>
      <div style={{ width:'100%', maxWidth:'400px' }}>
        <div style={{ textAlign:'center', marginBottom:'32px' }}>
          ...
          <p style={{ fontSize:'12px', color:'var(--muted)' }}>Reset your password</p>
        </div>
