...
export default function JobDetailPage() {
  ...
  if (isLoading) return (
    <div style={{ maxWidth:'1100px', margin:'0 auto', padding:'36px 4%' }}>
      {[...Array(3)].map((_,i)=><div key={i} className="gc" style={{ height:'120px', marginBottom:'16px', animation:'pulse 1.5s ease infinite' }} />)}
    </div>
  );
  ...
  return (
    <div style={{ display:'grid', gridTemplateColumns:'1fr 340px', gap:'24px', maxWidth:'1100px', margin:'0 auto', padding:'36px 4% 60px' }}>
      {/* Left — main content */}
      <div>
