...
export default function RoleProfilePage() {
  ...
  const { register, handleSubmit, setValue } = useForm({ defaultValues:{ roleType:role } });
  ...
  const FG = ({ children }: { children: React.ReactNode }) => <div style={{ display:'grid', gridTemplateColumns:'1fr 1fr', gap:'0 18px' }}>{children}</div>;
  ...
  return (
    <div style={{ minHeight:'calc(100vh - 68px)' }}>
      ...
      <div style={{ display:'grid', gridTemplateColumns:'1fr 340px', gap:'24px', maxWidth:'1100px', margin:'0 auto', padding:'32px 4% 60px' }}>
        {/* Left — forms */}
        <div>
          {/* Personal info */}
          <div className="gc" style={{ padding:'28px', marginBottom:'18px' }}>
            ...
            <FG>
              <div style={mb}><IL>Full Name *</IL><input {...register('fullName')} className="fi" placeholder="Your Full Name" /></div>
              ...
              <div style={mb}><IL>Mobile *</IL><input {...register('phone')} className="fi" placeholder="+91 98765 43210" /></div>
          ...
          <div className="gc" style={{ padding:'28px' }}>
            ...
            <FG>
              <div style={mb}><IL>Applied For *</IL><input {...register('appliedFor')} className="fi" placeholder="Specific role / position title" /></div>
              <div style={mb}><IL>Applied At *</IL><input {...register('appliedAt')} className="fi" placeholder="Organisation / Company name" /></div>
